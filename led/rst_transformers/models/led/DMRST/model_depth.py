    ...
    def TestingLoss(self, input_sentence, input_EDU_breaks, LabelIndex, ParsingIndex, GenerateTree, use_pred_segmentation):
        ...
        for i in range(len(EDU_breaks)):
            ...
            if len(EDU_breaks[i]) == 1:
                ...
                relation_value, topindex = relation_weights.topk(1)
                Relation_Values.append(relation_value.item())
                ...
                while stacks[-1] != '__StackRoot__':
                    ...
                    if len(stack_head) < 3:
                        ...
                        relation_weights, log_relation_weights = self.getlabel(input_left, input_right)
                        relation_value, topindex_label = relation_weights.topk(1)
                        Relation_Values.append(relation_value.item())
        ...
        return Loss_tree_batch, Loss_label_batch, (SPAN_batch if GenerateTree else None), (merged_label_gold, merged_label_pred), EDU_breaks, Relation_Values
